...
Page({
  ...
  //   wx.navigateTo({
  //     url: '/pages/shouye/zixunDetail/zixunDetail?id=' + id,
  //   })
  // },
  //banner
  banner() {
  ...
  onLoad: function (options) {
    ...
    //   key: 'VILBZ-JZ2WJ-IOGFC-KU53C-2GC67-AIB6T' // 必填
    // });
  ...
  //             const address=addressRes.result.ad_info.location;
  //             const city=addressRes.result.address_component.city
  //             console.log(address)
  //             vm.setData({
  //               lat:address.lat,
  //               lon:address.lng
  //             })
  //             wx.setStorageSync('city_lon', address.lat);
  //             wx.setStorageSync('city_lat', address.lng);
  //             vm.latlon();
  //         }
  //     });
  //     },
