...
Page({
  ...
  data: {
    delBtnWidth: 160,
    //   data: [{ content: "1", right: 0 }, { content: "1", right: 0 },{ content: "1", right: 0 },{ content: "1", right: 0 },{ content: "1", right: 0 }],
    list: [],
    token: '',
    pageNo: 1,
    totalPrice: '',
    ...
    wx.request({
      ...
      success: (res) => {
        ...
        if (res.data.status == 1) {
          ...
          var cartIds = []
          vm.setData({
            list: res.data.data.valid_goods_list,
    ...
    wx.showModal({
      ...
      success(ret) {
        ...
        if (ret.confirm) {
          console.log(vm.data.cartIds)
          wx.navigateTo({
            url: '/pages/shop/orderTj/orderTj?cartId=' + vm.data.cartIds + '&type=1&is_cart=1',
          })
        } else if (ret.cancel) {
